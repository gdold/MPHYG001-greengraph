...
The aim of this assessed exercise is to create a pip-installable package that would generate a graph of the proportion of green pixels in a series of satellite images between two points.
